...
canopen_interfaces__msg__CANSubscription__init(canopen_interfaces__msg__CANSubscription * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->data, 0)) {
    canopen_interfaces__msg__CANSubscription__fini(msg);
    return false;
  }
  return true;
}
...
canopen_interfaces__msg__CANSubscription__create()
{
  ...
  canopen_interfaces__msg__CANSubscription * msg = (canopen_interfaces__msg__CANSubscription *)allocator.allocate(sizeof(canopen_interfaces__msg__CANSubscription), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(canopen_interfaces__msg__CANSubscription));
  bool success = canopen_interfaces__msg__CANSubscription__init(msg);
  if (!success) {
...
canopen_interfaces__msg__CANSubscription__Sequence__init(canopen_interfaces__msg__CANSubscription__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  canopen_interfaces__msg__CANSubscription * data = NULL;

  if (size) {
    data = (canopen_interfaces__msg__CANSubscription *)allocator.zero_allocate(size, sizeof(canopen_interfaces__msg__CANSubscription), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = canopen_interfaces__msg__CANSubscription__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        canopen_interfaces__msg__CANSubscription__fini(&data[i - 1]);
      }
...
canopen_interfaces__msg__CANSubscription__Sequence__fini(canopen_interfaces__msg__CANSubscription__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      canopen_interfaces__msg__CANSubscription__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  canopen_interfaces__msg__CANSubscription__Sequence * array = (canopen_interfaces__msg__CANSubscription__Sequence *)allocator.allocate(sizeof(canopen_interfaces__msg__CANSubscription__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = canopen_interfaces__msg__CANSubscription__Sequence__init(array, size);
  if (!success) {
...
canopen_interfaces__msg__CANSubscription__Sequence__destroy(canopen_interfaces__msg__CANSubscription__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    canopen_interfaces__msg__CANSubscription__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
canopen_interfaces__msg__CANSubscription__Sequence__are_equal(const canopen_interfaces__msg__CANSubscription__Sequence * lhs, const canopen_interfaces__msg__CANSubscription__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!canopen_interfaces__msg__CANSubscription__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  canopen_interfaces__msg__CANSubscription__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(canopen_interfaces__msg__CANSubscription);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    canopen_interfaces__msg__CANSubscription * data =
      (canopen_interfaces__msg__CANSubscription *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!canopen_interfaces__msg__CANSubscription__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          canopen_interfaces__msg__CANSubscription__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!canopen_interfaces__msg__CANSubscription__copy(
