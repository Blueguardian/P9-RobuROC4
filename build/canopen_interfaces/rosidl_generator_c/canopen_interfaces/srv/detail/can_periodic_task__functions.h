...
#ifndef CANOPEN_INTERFACES__SRV__DETAIL__CAN_PERIODIC_TASK__FUNCTIONS_H_
#define CANOPEN_INTERFACES__SRV__DETAIL__CAN_PERIODIC_TASK__FUNCTIONS_H_
...
/// Initialize srv/CANPeriodicTask message.
/**
...
/// Finalize srv/CANPeriodicTask message.
/**
...
/// Create srv/CANPeriodicTask message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * canopen_interfaces__srv__CANPeriodicTask_Request__init().
...
/// Destroy srv/CANPeriodicTask message.
/**
 * It calls
 * canopen_interfaces__srv__CANPeriodicTask_Request__fini()
...
/// Check for srv/CANPeriodicTask message equality.
/**
...
/// Copy a srv/CANPeriodicTask message.
/**
...
/// Initialize array of srv/CANPeriodicTask messages.
/**
...
/// Finalize array of srv/CANPeriodicTask messages.
/**
 * It calls
 * canopen_interfaces__srv__CANPeriodicTask_Request__fini()
...
/// Create array of srv/CANPeriodicTask messages.
/**
 * It allocates the memory for the array and calls
 * canopen_interfaces__srv__CANPeriodicTask_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CANPeriodicTask messages.
/**
 * It calls
 * canopen_interfaces__srv__CANPeriodicTask_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CANPeriodicTask message array equality.
/**
...
/// Copy an array of srv/CANPeriodicTask messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * canopen_interfaces__srv__CANPeriodicTask_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_canopen_interfaces
...
/**
 * It calls
 * canopen_interfaces__srv__CANPeriodicTask_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_canopen_interfaces
...
/**
 * It allocates the memory for the array and calls
 * canopen_interfaces__srv__CANPeriodicTask_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_canopen_interfaces
...
/**
 * It calls
 * canopen_interfaces__srv__CANPeriodicTask_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CANOPEN_INTERFACES__SRV__DETAIL__CAN_PERIODIC_TASK__FUNCTIONS_H_
