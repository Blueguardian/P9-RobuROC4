...
#ifndef CANOPEN_INTERFACES__SRV__DETAIL__CAN_CONNECTION__FUNCTIONS_H_
#define CANOPEN_INTERFACES__SRV__DETAIL__CAN_CONNECTION__FUNCTIONS_H_
...
/// Initialize srv/CANConnection message.
/**
...
/// Finalize srv/CANConnection message.
/**
...
/// Create srv/CANConnection message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * canopen_interfaces__srv__CANConnection_Request__init().
...
/// Destroy srv/CANConnection message.
/**
 * It calls
 * canopen_interfaces__srv__CANConnection_Request__fini()
...
/// Check for srv/CANConnection message equality.
/**
...
/// Copy a srv/CANConnection message.
/**
...
/// Initialize array of srv/CANConnection messages.
/**
...
/// Finalize array of srv/CANConnection messages.
/**
 * It calls
 * canopen_interfaces__srv__CANConnection_Request__fini()
...
/// Create array of srv/CANConnection messages.
/**
 * It allocates the memory for the array and calls
 * canopen_interfaces__srv__CANConnection_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CANConnection messages.
/**
 * It calls
 * canopen_interfaces__srv__CANConnection_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CANConnection message array equality.
/**
...
/// Copy an array of srv/CANConnection messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * canopen_interfaces__srv__CANConnection_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_canopen_interfaces
...
/**
 * It calls
 * canopen_interfaces__srv__CANConnection_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_canopen_interfaces
...
/**
 * It allocates the memory for the array and calls
 * canopen_interfaces__srv__CANConnection_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_canopen_interfaces
...
/**
 * It calls
 * canopen_interfaces__srv__CANConnection_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CANOPEN_INTERFACES__SRV__DETAIL__CAN_CONNECTION__FUNCTIONS_H_
