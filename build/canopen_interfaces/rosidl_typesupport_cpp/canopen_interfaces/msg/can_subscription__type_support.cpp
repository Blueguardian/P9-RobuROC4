...
static const _CANSubscription_type_support_symbol_names_t _CANSubscription_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, canopen_interfaces, msg, CANSubscription)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, canopen_interfaces, msg, CANSubscription)),
  }
};
...
{
  return &::canopen_interfaces::msg::rosidl_typesupport_cpp::CANSubscription_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, canopen_interfaces, msg, CANSubscription)() {
  return get_message_type_support_handle<canopen_interfaces::msg::CANSubscription>();
}
