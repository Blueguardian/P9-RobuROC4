...
#ifndef CANOPEN_INTERFACES__SRV__DETAIL__CAN_READ__FUNCTIONS_H_
#define CANOPEN_INTERFACES__SRV__DETAIL__CAN_READ__FUNCTIONS_H_
...
/// Initialize srv/CANRead message.
/**
...
/// Create srv/CANRead message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * canopen_interfaces__srv__CANRead_Request__init().
...
/// Destroy srv/CANRead message.
/**
 * It calls
 * canopen_interfaces__srv__CANRead_Request__fini()
...
/// Check for srv/CANRead message equality.
/**
...
/// Initialize array of srv/CANRead messages.
/**
...
/// Finalize array of srv/CANRead messages.
/**
 * It calls
 * canopen_interfaces__srv__CANRead_Request__fini()
...
/// Create array of srv/CANRead messages.
/**
 * It allocates the memory for the array and calls
 * canopen_interfaces__srv__CANRead_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CANRead messages.
/**
 * It calls
 * canopen_interfaces__srv__CANRead_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CANRead message array equality.
/**
...
/// Copy an array of srv/CANRead messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * canopen_interfaces__srv__CANRead_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_canopen_interfaces
...
/**
 * It calls
 * canopen_interfaces__srv__CANRead_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_canopen_interfaces
...
/**
 * It allocates the memory for the array and calls
 * canopen_interfaces__srv__CANRead_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_canopen_interfaces
...
/**
 * It calls
 * canopen_interfaces__srv__CANRead_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CANOPEN_INTERFACES__SRV__DETAIL__CAN_READ__FUNCTIONS_H_
