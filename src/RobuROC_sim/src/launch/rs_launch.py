...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '640x480x15', 'description': 'color stream profile'},    # edited. Default : '0,0,0'
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '640x480x15', 'description': 'depth stream profile'},      # edited. Default : '0,0,0'
                           ...
                           {'name': 'clip_distance',                'default': '3.5', 'description': "''"},                                            #edited
