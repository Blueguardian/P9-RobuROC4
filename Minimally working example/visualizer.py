...
while running:
    ...
    a_btn = pressed[controller.BUTTONS('A')]
    b_btn = pressed[controller.BUTTONS('B')]
    x_btn = pressed[controller.BUTTONS('X')]
    y_btn = pressed[controller.BUTTONS('Y')]
    back = pressed[controller.BUTTONS('BACK')]
    start = pressed[controller.BUTTONS('START')]
    # guide = pressed[xbox360_controller.GUIDE]
    lt_bump = pressed[controller.BUTTONS('LEFT_BUMP')]
    rt_bump = pressed[controller.BUTTONS('RIGHT_BUMP')]
    lt_stick_btn = pressed[controller.BUTTONS('LEFT_STICK_BTN')]
    rt_stick_btn = pressed[controller.BUTTONS('RIGHT_STICK_BTN')]
